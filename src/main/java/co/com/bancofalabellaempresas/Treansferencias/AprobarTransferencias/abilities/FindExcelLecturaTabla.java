...
@Slf4j
public class FindExcelLecturaTabla {


    //validar tamaño excel
    public static Boolean leerExcel(String rutaarchivo, String valueCell) {
        int fil = 1;
        int col = 0;
        int maxcol = 0;
        ...
        try {
            ...
            while (filas.hasNext()) {
                ...
                while (columnas.hasNext()) {
                    ...
                    if (valor.equals(valueCell)) {
                        finded = true;
                        //System.out.println("valor encontradom fila:" + fil + " columna:" + col + " = " + valor);
